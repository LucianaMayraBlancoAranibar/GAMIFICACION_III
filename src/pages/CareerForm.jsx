...
function careerForm() {
    ...
    const [careerName, setCarrerName] = useState("");
    const [Departemento, setDepartamento] = useState("");
    ...
    const validateForm = () => {
        ...
        if (!careerName) {
            ...
            setCarrerNameError(
                "El nombre de la carrera debe tener más de 3 caracteres y menos de 50 caracteres"
            );
            isValid = false;
        } else {
            setCarrerNameError("");
        ...
        return isValid; // Agrega esta línea para devolver el valor de isValid
    };
                        ...
                        <div>
                            <div>
                                ...
                                {Departemento.length === 0 ? (
                                    ...
                                    >
                                        <option value="">Selecciona un Departemento</option>
                                        {Departemento.map((departamento) => (
                                            <option
                                                key={departamento.idDepartment}
                                                value={departamento.idDepartment}
                                            >
