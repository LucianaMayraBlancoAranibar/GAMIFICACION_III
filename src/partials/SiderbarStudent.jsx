...
function SidebarStudent({ sidebarOpen, setSidebarOpen }) {
  ...
  return (
    <div>
      {/* SidebarStudent backdrop (mobile only) */}
      <div
            ...
            <ul className="mt-3">
              ...
              {/* E-Commerce */}
                ...
                <NavLink
                  ...
                  className={`block text-slate-200 truncate transition duration-150 ${
                    pathname.includes('StudentBadgesView') ? 'hover:text-slate-200' : 'hover:text-white'
                  }`}
                >
                  <div className="flex items-center">
              ...
              <li className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 ${pathname.includes('RegisterManager') && 'bg-slate-900'}`}>
                <NavLink
                  ...
                  to="/StudentAchievementsView"
                  className={`block text-slate-200 truncate transition duration-150 ${
                    pathname.includes('StudentAchievementsView') ? 'hover:text-slate-200' : 'hover:text-white'
                  }`}
                >
                  <div className="flex items-center">
                    <svg className="shrink-0 h-6 w-6" viewBox="0 0 24 24">
              ...
              <li className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 ${pathname.includes('RegisterManager') && 'bg-slate-900'}`}>
                <NavLink
                  ...
                  to="/StudentSanctionsView"
                  className={`block text-slate-200 truncate transition duration-150 ${
                    pathname.includes('StudentSanctionsView') ? 'hover:text-slate-200' : 'hover:text-white'
                  }`}
                >
                  <div className="flex items-center">
                    <svg className="shrink-0 h-6 w-6" viewBox="0 0 24 24">
