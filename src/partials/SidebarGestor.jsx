    ...
    <div>
      ...
      >
        ...
        <div className="flex justify-between mb-10 pr-3 sm:px-2">
          ...
          {/* Logo */}
          <NavLink end to="/DashboardGestor" className="block">
        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <ul className="mt-3">
              ...
              <SidebarLinkGroup
                activecondition={
                  pathname === "/DashboardGestor" || pathname.includes("DashboardGestor")
                }
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <a
                        ...
                        className={`block text-slate-200 truncate transition duration-150 ${
                          pathname === "/DashboardGestor" || pathname.includes("dashboard")
                      ...
                      >
                        <div className="flex items-center justify-between">
                          ...
                          <div className="flex shrink-0 ml-2">
                            <svg
                              className={`w-3 h-3 shrink-0 ml-1 fill-current hover:text-white ${
                                open && "rotate-180"
                              }`}
                              viewBox="0 0 12 12"
                            >
          ...
          <div className="px-3 py-2">
            <button onClick={() => setSidebarExpanded(!sidebarExpanded)}>
              ...
              >
                ...
                />
                <path className="text-gray-500" d="M3 23H1V1h2z" />
              </svg>
            </button>
          </div>
        </div>
